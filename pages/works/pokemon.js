...
const data = {
  ...
  description: [
    `This app can play Pokemon on the browser. I created this app with a few people. What I learned creating this app are below. I used an API called "pokeapi" in this app. by using that, I learned how to use useSWR as a custom hook. And, I realized that When I use the custom hook, I have to take care of it's not more than 2 layers below the component I use the custom hook. It caused a problem, so I decide to confirm that it is used directly below the component.`,
